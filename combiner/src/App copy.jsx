...
function App() {
  ...
  const columns = useMemo(() => [
    ...
    columnHelper.accessor('ignoreCase', {
      header: 'Ignore Case',
      cell: info => (
        <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${info.getValue()
    ...
    columnHelper.accessor('target', {
      header: 'Target',
      cell: info => (
        <code className="px-2 py-1 bg-blue-100 rounded text-sm font-mono text-blue-800">
          {info.getValue()}
        </code>
      ),
    }),
    columnHelper.accessor('condition', {
      header: 'Condition',
      cell: info => (
        <code className="px-2 py-1 bg-yellow-100 rounded text-sm font-mono text-yellow-800 max-w-xs truncate">
          {info.getValue()}
        </code>
      ),
    }),
  ...
  const table = useReactTable({
    data: Object.keys(regexList).map((file, i) => {
      Object.keys(regexList[file]["regexes"]).map(regex => {
        return {
          description: regexList[file]["regexes"][regex].description,
          ignoreCase: regexList[file]["regexes"][regex].ignoreCase,
          source: regexList[file]["regexes"][regex].source,
          target: regexList[file]["regexes"][regex].target,
          condition: regexList[file]["regexes"][regex].condition,
        }
      })
    }),
    columns,
                          ...
                          <tr className="hover:bg-base-300" key={"regex" + j} data-file-id={file} data-regex-id={regex}>
                            ...
                            <td>
                              <textarea
                                ...
                                defaultValue={regexList[file]["regexes"][regex]?.description} />
                            ...
                            <td>
                              <select data-file-id={file} data-regex-id={regex} data-field="ignoreCase"
                                onBlur={handleChanges}
                                defaultValue={regexList[file]["regexes"][regex]?.ignoreCase}
                            ...
                            <td className='wrap-anywhere'>
                              <textarea
                                ...
                                onBlur={handleChanges}
                                defaultValue={regexList[file]["regexes"][regex]?.source}
                            ...
                            <td className='wrap-anywhere'>
                              <textarea
                                ...
                                onBlur={handleChanges}
                                defaultValue={regexList[file]["regexes"][regex]?.target}
                            ...
                            <td className=''>
                              <select data-file-id={file} data-regex-id={regex} data-field="condition"
                                onBlur={handleChanges}
                                defaultValue={regexList[file]["regexes"][regex]?.condition}
                                className="select select-accent">
